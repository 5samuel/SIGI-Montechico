...
import { Configuracion, ErrorMolecula, Home, Login, Marca, ProtectedRoute, SpinnerLoader, useEmpresaStore, UserAuth, useUsuariosStore, Categorias, Productos, Usuarios } from "../index";
...
export function MyRoutes() {
  ...
  queryFn: async () => {
    const res = await mostrarEmpresa({ idusuario });
    console.log("RESPUESTA EMPRESA:", res);
    return res;
  },
  enabled: !!idusuario
});

const {data:datapermisos}=useQuery({queryKey:["mostrar Permisos", {id_usuario:idusuario}], 
